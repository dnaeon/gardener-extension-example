...
EXTENSION_RESOURCE_NAME ?= gardener-extension-example
...
.PHONY: deploy
deploy: generate update-version-tags docker-build docker-push helm-load-chart  ## Deploy to local dev cluster with Gardener Operator.
	@env \
